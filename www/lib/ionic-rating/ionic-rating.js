...
(function() {
  angular.module('ionic.rating', []).constant('ratingConfig', {
    ...
    return {
      ...
      template: '<ul class="rating" ng-keydown="onKeydown($event)">' + '<li ng-repeat="r in range track by $index" ng-click="rate($index + 1)"><i class="icon custom-star-icon" ng-class="value === undefined ? (r === 1 ? \'ion-ios-star\' : (r === 2 ? \'ion-ios-star-half\' : \'ion-ios-star-outline\')) : (value > $index ? \'ion-ios-star\' : \'ion-ios-star-outline\')"></i></li>' + '</ul>',
      replace: true,
